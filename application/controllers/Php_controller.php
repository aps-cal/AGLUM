<?php
class Php_controller extends CI_Controller {
...
//    }
    ...
    public function html($php){
        if ( ! file_exists('application/views/php/'.$php.'.php')){
        ...
        $data['title'] = ucfirst($php); // Capitalize the first letter
//      $this->load->view('templates/header', $data);
        $this->load->view('php/'.$php.'.php', $data);
